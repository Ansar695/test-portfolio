...
const ProductsHome = () => {
  ...
  return (
    <>
      <div className="w-full max-w-[300px] bg-[#0a4275] border border-blue-400 rounded-[6px] shadow">
        <Link href="#">
          <img
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className=" border rounded-[5px] border-blue-400 font-medium text-sm px-5 py-2.5 text-center"
            >
              View Detail
            </Link>
          </div>
